...
@Schema(description = "管理后台 - 租金账单创建/修改 Request VO")
@Data
public class RentBillSaveReqVO {
    ...
    @Schema(description = "费用周期开始日期", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "费用周期开始日期不能为空")
    private LocalDate periodStart;

    @Schema(description = "费用周期结束日期", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "费用周期结束日期不能为空")
    ...
    @Schema(description = "应缴总金额（元）", requiredMode = Schema.RequiredMode.REQUIRED, example = "3700.00")
