...
@Schema(description = "管理后台 - 业主信息 Response VO")
@Data
public class OwnerInfoRespVO {

    @Schema(description = "业主编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    private Long id;
    ...
    @Schema(description = "手机号", example = "13700137000")
